                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control @error('postcode') is-invalid @enderror" name="country" value="{{ old('postcode') }}" required autocomplete="postcode" autofocus>
